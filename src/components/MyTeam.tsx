...
export default function MyTeam({ onViewProfile }: { onViewProfile?: (id: string) => void }) {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto flex flex-col gap-12">
      <section className="relative overflow-hidden rounded-3xl p-12 bg-[#111111] border group">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
           ...
           <div className="md:ml-auto flex flex-col items-center md:items-end">
              ...
              <span className="text-[10px] uppercase font-bold opacity-30 tracking-widest mt-1">Team Total Points</span>
           </div>
        </div>
      </section>
