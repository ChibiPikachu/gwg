        ...
        <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-zinc-900/90 p-1.5 rounded-2xl border dark:border-white/10 border-black/10 shrink-0 w-full sm:w-auto">
          ...
          >
            ...
            {previousEvents.length > 0 && (
              <span className="px-2 py-0.5 rounded-full text-[10px] font-black bg-x-slate-500/20 text-x-slate-500 border border-x-slate-500/30">
      ...
      {activeTab === 'current' && (
        <div className="flex flex-col gap-8 md:gap-12">
          <section>
            ...
            {hideScores && (
              <div className="mb-8 p-4 rounded-xl bg-x-slate-500/10 border border-x-slate-500/25 text-x-slate-500 font-bold text-center text-sm tracking-wide animate-pulse">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              <div>
                <h2 className="text-xl font-bold flex items-center gap-3">
                  <Trophy className="text-x-slate-400" size={24} />
                  All Members
                </h2>
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                <div className="relative flex-1 sm:w-64 min-w-[200px]">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-8 py-2 text-xs rounded-xl dark:bg-[#111111] bg-white border border-black/10 dark:border-white/10 focus:outline-none focus:ring-2 focus:ring-x-slate-500/50 shadow-sm transition-all placeholder:opacity-40"
                  />
                  {searchQuery && (
                    <button
              ...
              <div className="mb-4 flex items-center justify-between text-[11px] font-bold opacity-50 px-1">
                ...
                {(searchQuery || teamFilter !== 'all') && (
                  <button
                    ...
                    className="text-x-slate-500 hover:underline flex items-center gap-1 font-bold"
                  >
                    Reset Filters
                  </button>
                )}
                  ...
                  return (
                    <div key={u.steamid} className="flex items-center gap-4 p-4 dark:bg-[#111111] bg-white rounded-2xl border border-black/5 dark:border-white/5 group hover:border-black/10 dark:hover:border-white/10 transition-all shadow-sm dark:shadow-none">
                      ...
                      <div className="text-right">
                        <div className="font-mono font-bold text-x-slate-400">
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isSelected
                          ? "bg-x-slate-500/10 border-x-slate-500/30 text-x-slate-500 shadow-sm"
                    ...
                    >
                      ...
                      {evt.winner_team && (
                        <span className={cn(
                          ...
                          TEAM_COLORS[evt.winner_team as Team]?.secondary || "bg-x-slate-500/20",
                          TEAM_COLORS[evt.winner_team as Team]?.primary || "text-x-slate-400"
                        )}>
                          🏆 {evt.winner_team}
                        </span>
                      )}
                ...
                <div className="flex flex-col gap-8 md:gap-10 animate-in fade-in duration-200">
                  ...
                  <div className="p-6 md:p-8 rounded-3xl dark:bg-[#111111] bg-white border border-black/5 dark:border-white/10 shadow-lg flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <span className="px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-x-slate-500/10 text-x-slate-500 border border-x-slate-500/20">
                    ...
                    {previousEventData.event.winner_team && (
                      <div className={cn(
                        ...
                        TEAM_COLORS[previousEventData.event.winner_team as Team]?.secondary || "bg-x-slate-500/10",
                        TEAM_COLORS[previousEventData.event.winner_team as Team]?.border || "border-x-slate-500/20"
                      )}>
                        <div className="w-10 h-10 rounded-xl bg-x-slate-500/20 flex items-center justify-center text-xl shrink-0">
                          🏆
                        </div>
                        <div>
                        ...
                        return (
                          <div 
                            ...
                            className={cn(
                              ...
                              isWinner && "ring-2 ring-x-slate-500/50 shadow-x-slate-500/10"
                            )}
                          >
                            {isWinner && (
                              <div className="absolute top-0 right-0 bg-x-slate-500 text-black text-[9px] font-black uppercase px-2.5 py-0.5 rounded-bl-xl tracking-wider">
                                Winner
                              </div>
                            )}
                  ...
                  <section>
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                      <div>
                        <h3 className="text-xl font-bold flex items-center gap-2">
                          <Trophy className="text-x-slate-400" size={22} />
                          ...
                          return (
                            <div 
                              ...
                              className={cn(
                                ...
                                isTop3 
                                  ? "border-x-slate-500/30 dark:bg-x-slate-500/[0.02]" 
                            ...
                            >
                              ...
                              <div className="text-right shrink-0">
                                <div className="font-mono font-black text-x-slate-400 text-base">
